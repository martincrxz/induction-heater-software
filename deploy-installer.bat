...
rem no funcionará
set PATH=C:\Qt\5.14.1\mingw73_32\bin;C:\Qt\Tools\mingw730_32\bin;C:\Qt\Tools\QtInstallerFramework\3.2\bin;%PATH%
echo Building...
...
move horno-induccion.exe ..\deploy\packages\fiuba.solidos.amorfos\data
