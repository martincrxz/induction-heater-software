...
#define FUZZY_ERROR_SENSITIVITY "Sensibilidad del error: %.2f"
#define FUZZY_DERIVATIVE_ERROR_SENSITIVITY "Sensibilidad de la derivada del error: %.2f"
#define FUZZY_OUTPUT_SENSITIVITY "Sensibilidad de la salida: %.2f"
#define FUZZY_KP_SENSITIVITY "Sensibilidad de Kp: %.2f"
#define FUZZY_KD_SENSITIVITY "Sensibilidad de Kd: %.2f"
#define FUZZY_KI_SENSITIVITY "Sensibilidad de Ki: %.2f"
